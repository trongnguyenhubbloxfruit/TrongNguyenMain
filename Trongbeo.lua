...
_G.NameHub = "" -- ชื่อ Hub
_G.Title = "TrongNguyen Roblox" -- คำอธิบาย
-----------------------------------------------------------------
	...
	coroutine.resume(
		coroutine.create(
			function()
				...
				Circle.ZIndex = 10
				Circle.Image = "rbxassetid://88898679316957"
...
Disc_Logo.Image = "http://www.roblox.com/asset/?id=88898679316957"
    ...
    ["embeds"] = {
        {
            ...
            ["fields"] = {
                ...
                },
                {
                    ...
                    ["value"] = "Đã Dùng Script Của TrongNguyen Roblox✅",
                    ["inline"] = false
                }
            }
        }
